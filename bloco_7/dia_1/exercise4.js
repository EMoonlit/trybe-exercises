...
HTML; ...
#goTrybe".*/
const array = ['JavaScript', 'CSS', 'HTML Semantic', 'Suport IT'];

function frase (nome) {
    const adicionando_nome = addName => (`Tryber ${addName} aqui!
    Tudo bem?`);

    let resultado = `${adicionando_nome(nome)}
